    ...
    <div class="container-fluid">
        <div class="receipt-container">
            ...
            <div class="payment-details">
                <div class="two-column">
                    <div class="left-column">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-value">{{ ucfirst($pembayaran->tagihan_detail->status ?? 'belum lunas') }}
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="form-value">
                                @if ($pembayaran->status_konfirmasi == 'Belum Dikonfirmasi')
                                    <span style="color: #ffc107; font-weight: bold;">MENUNGGU KONFIRMASI</span>
                                @else
                                    <span style="color: #28a745; font-weight: bold;">SUDAH DIKONFIRMASI</span>
                                @endif
                            </div>
                        </div>
                        @if ($pembayaran->bank_sekolah)
                            <div class="form-row">
                                <label class="form-label">Bank Sekolah</label>
                                <div class="form-value">{{ $pembayaran->bank_sekolah->nama_bank }}</div>
                            </div>
                            <div class="form-row">
                                <label class="form-label">No. Rekening</label>
                                <div class="form-value">{{ $pembayaran->bank_sekolah->no_rekening }}</div>
                            </div>
                        @endif
                    </div>
                ...
                @if ($pembayaran->status_konfirmasi == 'Belum Dikonfirmasi')
                    <div class="payment-for" style="border-color: #ffc107; background-color: #fff3cd;">
                        <div class="payment-for-title" style="color: #856404;">⚠️ PENTING:</div>
                        <div class="payment-for-content" style="background-color: #fff3cd; color: #856404;">
                            <strong>Pembayaran ini masih menunggu konfirmasi dari admin/operator.</strong><br>
                            Kuitansi ini hanya sebagai bukti pengajuan pembayaran.
                            Status akan berubah menjadi "SUDAH DIKONFIRMASI" setelah admin memverifikasi bukti pembayaran.
                        </div>
                    </div>
                @endif
            </div>
