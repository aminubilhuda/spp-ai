...
<head>
    ...
    <title>{{ $title ?? "Sistem Pembayaran Sekolah" }} | {{ config('app.name', 'Laravel') }}</title>
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end p-0">
                                                    ...
                                                    <li class="list-group-item list-group-item-action dropdown-notifications-item" data-notification-id="{{ $notification->id }}">
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="flex-shrink-0 dropdown-notifications-actions">
                                                                ...
                                                                <a href="{{ route('pembayaran.index') }}" class="dropdown-notifications-archive"><span class="icon-base bx bx-x"></span></a>
                                                            </div>
                                                        </div>
                                                    </li>
                                                @empty
                                        ...
                                        <li class="border-top">
                                            <div class="d-grid p-4">
                                                <a class="btn btn-primary btn-sm d-flex" href="{{ route('pembayaran.index') }}">
                                                    <small class="align-middle">Lihat semua pembayaran</small>
                                                </a>
                                            </div>
                                        </li>
                                    </ul>
