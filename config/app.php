...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | These options determine the driver used to determine and inform Laravel
    | of "maintenance mode" status. The "cache" driver will provide the
    | best performance, while "file" should be used when using a shared
    | server configuration where the file-based approach may not work.
    |
    */
